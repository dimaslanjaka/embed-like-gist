...
const tsconfigBase: typeof import('./tsconfig.json') = jsonc.parse(
  readFileSync(join(__dirname, 'tsconfig.json'), 'utf-8')
);
const tsconfigJest: typeof import('./tsconfig.build.json') = jsonc.parse(
  readFileSync(join(__dirname, 'tsconfig.build.json'), 'utf-8')
);
